#
#  Be sure to run `pod spec lint MYKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/sunjinshuai/MYScoreStarView.git", :tag => "0.0.1" 
  }
  ...
  s.source_files  = "MYScoreStarView/MYScoreStarView/**/*.{h,m}"
